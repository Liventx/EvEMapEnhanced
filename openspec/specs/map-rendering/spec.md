...
- GIVEN EvE-Scout reports an active wormhole signature from a mapped k-space system into Thera
  and the user has enabled Thera/Turnur wormhole markers in the Map menu
