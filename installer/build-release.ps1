...
if ($IsccCandidates) {
    ...
    Write-Host "Installer: $ReleaseDir\EvEMapEnhanced-Setup-Alfa-1.3.exe"
} else {
    $ZipPath = Join-Path $ReleaseDir "EvEMapEnhanced-Alfa-1.3-win-x64.zip"
    ...
    Write-Host "Install Inno Setup 6 to produce EvEMapEnhanced-Setup-Alfa-1.3.exe"
}
